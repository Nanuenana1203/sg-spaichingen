      ...
      {!auswahl ? (
                  ...
                  {filteredMitglieder.map(m => (
                    <tr key={m.id} className="border-t hover:bg-blue-50">
                      ...
                      <td className="px-4 py-2 text-right">
                        <button onClick={() => { setKorb([]); setAuswahl(m); }} className="px-3 py-1 text-sm bg-blue-600 text-white rounded hover:bg-blue-700">
                          Übernehmen
                        </button>
                      </td>
                    </tr>
        ...
        <div className="rounded-xl border bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => { setKorb([]); setAuswahl(null); }} className="ml-auto px-3 py-2 rounded-lg text-sm bg-blue-600 text-white hover:bg-blue-700">
              Mitglied wechseln
            </button>
          </div>
        </div>
